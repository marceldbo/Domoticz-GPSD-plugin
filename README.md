...
Create a new directory in /home/pi/domoticz/plugins, e.g. gpsd, and place the plugin.py file in this directory. Make the file executable: sudo chmod 755. Now stop and start the domoticz service. The plugin should be selectable under the Hardware tab. Before configuring, make sure that Domoticz accepts new devices. Configure the plugin. A new GPS device should be available under the Devices tab.
